...
const ui_encrypt_article = (article_id) => {
  ...
  <button class="btn btn-primary" id="encryptionOptionsModalEncryptBtn">${langdata.ENCRYPT_ARTICLE[lang_name]}</button>
    `;
...
const ui_decrypt_article = (article_id) => {
  ...
  <button class="btn btn-primary" id="encryptionOptionsModalDecryptBtn">${langdata.DECRYPT_ARTICLE[lang_name]}</button>
    `;
