...
module.exports = function (prompt_type, language, content) {
  ...
  switch (prompt_type) {
  case "textCompletion":
    return prompt_base["textCompletion"][language].replaceAll("{content}",content);
  case "textSummary":
    return prompt_base["textSummary"][language].replaceAll("{content}",content);
  case "textImprove":
    return prompt_base["textImprove"][language].replaceAll("{content}",content);
  }
};