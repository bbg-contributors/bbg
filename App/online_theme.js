...
function render_theme_detail(theme_id) {
  ...
  <button class="btn btn-primary" onclick="render_online_theme_list();"><i class="fa fa-arrow-left"></i> 返回主题列表</button><br /><br />
  ...
  <hr />
  <button class="btn btn-primary" onclick="install_theme(${theme_id})"><i class="fa fa-download"></i> ${langdata.INSTALL_THIS_THEME[lang_name]}</button>
  <button class="btn btn-primary" onclick="render_online_theme_list();">${langdata.BACK_TO_THEME_LIST[lang_name]}</button><br /><br />
