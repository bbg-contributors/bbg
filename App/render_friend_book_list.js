  ...
  for (let i = 0; i < blog["友人帐"].length; i++) {
    document.getElementById("friend_book_list").innerHTML += `
        <tr>
          ...
          <td><button class="fluentbtn friendbtn" onclick="delete_friend(${i})"><i class="fa fa-close" ></i></button></td>
          <td><button class="fluentbtn friendbtn" onclick="let_friend_up(${i})"><i class="fa fa-arrow-up"></i></button></td>
          <td><button class="fluentbtn friendbtn" onclick="let_friend_down(${i})"><i class="fa fa-arrow-down"></i></button></td>
