...
storage.get("language", (error, data) => {
  ...
  document.getElementById("preview_site_content").innerHTML = `
    ...
    <button class="btn btn-outline-primary" onclick="commit_and_push();">${langdata.PUSH_TO_REMOTE[lang_name]}</button>
    <button class="btn btn-outline-primary" onclick="commit_only()">${langdata.PUSH_TO_REMOTE_WITHOUT_PUSH[lang_name]}</button>
    <br /><br />
    <hr />
    ...
    <button class="btn btn-outline-primary" onclick="secure_copy_pass();">${langdata.COPY_TO_REMOTE_WITH_PASSWD[lang_name]}</button>
    <button class="btn btn-outline-primary" onclick="secure_copy_key()">${langdata.COPY_TO_REMOTE_WITH_KEY[lang_name]}</button>
    <hr />
