...
module.exports = function () {
  ...
  for (let i = 0; i < blog["文章列表"].length; i++) {
    ...
    <button class="btn btn-outline-primary" onclick="edit_article('${blog["文章列表"][i]["文件名"]}')"><i class="fa fa-edit"></i> ${langdata.EDIT_AND_PREVIEW_ARTICLE_CONTENT[lang_name]}</button>
