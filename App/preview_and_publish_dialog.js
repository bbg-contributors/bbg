...
module.exports = function(){
  ...
  <div id="preview_site_content" style="display: block;">
    ...
    <button class="btn btn-success" onclick="preview_and_publish.openInBrowser()">${langdata.PREVIEW_SITE_IN_BROWSER[lang_name]}</button>
  </div>
  <div id="publish_site_content" style="display: none;">
    ...
    <button class="btn btn-primary" onclick="preview_and_publish.commit_and_push();">${langdata.PUSH_TO_REMOTE[lang_name]}</button>
    <button class="btn btn-primary" onclick="preview_and_publish.commit_only()">${langdata.PUSH_TO_REMOTE_WITHOUT_PUSH[lang_name]}</button>
    <br /><br />
    <hr />
    ...
    <button class="btn btn-primary" onclick="preview_and_publish.secure_copy_pass();">${langdata.COPY_TO_REMOTE_WITH_PASSWD[lang_name]}</button>
    <button class="btn btn-primary" onclick="preview_and_publish.secure_copy_key()">${langdata.COPY_TO_REMOTE_WITH_KEY[lang_name]}</button>
    <hr />
    ...
    <button class="btn btn-primary" onclick="open_blog_dir()">${langdata.OPEN_SITE_ROOTDIR[lang_name]}</button>
