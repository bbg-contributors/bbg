...
* Support for checking thirdparty themes for updates
* Support for setting third party themes (subject support required)
* Fixed the issue with the clipboard can't be used on macOS
* Support for setting Japanese as the site language (Thanks to [@Misaka13514](https://atri.tk) for contributing!)
* Other technical updates such as update Electron and versions of dependent libraries (Thanks to [@mzwing](https://mzwing.eu.org) and [@Misaka13514](https://atri.tk) for their contributions)
...
* Improvement on i18n
* Fixed the issue which generated blogs would still appear in the archive and TAB screen after its posts had been hidden
...
* Added support for Russian (Thanks to [杨冬冬](https://github.com/yangdongstation) for contributing!)

**Technical updates related to i18n**

* Fallback mechanism is now provided when the language file is incomplete
* Support for backchecking the integrity of meta.json（Thanks to [Misaka13514](https://github.com/Misaka13514) for contributing!）
* A script is now available for creating new translation files and generating templates（Thanks to[scientificworld](https://github.com/scientificworld) for contributing!）

## 20220805
* Updated the version of valine used by the blog to 1.5.1, fixing a possible xss vulnerability
* Added support for traditional Chinese and Japanese (Thanks to [Misaka13514](https://github.com/Misaka13514) for contributing!)
...
* The theme store now only supports downloading theme-v2. Installation of theme-v1 by any means is no longer supported. Fixed the issue which in some cases, default theme could not be reset  
...
## 20220715
* Fixed the issue which the browser navigation (forward&back) buttons failed under new routing mode
...
## 20220704
* Fixed the issue which deleting articles and deleting pages would not trigger rss and sitemap updates
...
* Experimental bbg theme-v2 (Mostly done by [@chihuo2104](https://github.com/chihuo2104) Thanks for contributing!)
...
* The blog's valine have been updated to ver.1.4.18, a possible xss vulnerability is fixed. This will help to resolve the problem which the comment system were failed to load
...
## 20220522
* New App icon
* Fixed the issue which the profile picture in the friend blog accounts showed a white edge

## 20220515
* Support for dark themes
* Installation packages are available for download from this release. (Thanks to [mzwing](https://mzwing.eu.org/) & [Misaka13514](https://blog.atri.tk) for their contributions!).

## 20220507
* The theme store source repository was changed to GitHub
* Software update source was changed to GitHub
...
* Fixed the bug which the number of articles per page setting could not be saved
...
* **Security Update** Updated the version of valine that generated the blog to ver.1.4.16, which fixes an XSS vulnerability in Valine (see GitHub xCss/Valine Issues #368 #363 #352 #348 for details). For the security of your site, update it as soon as possible. (Thanks to [@Misaka13514](https://atri.tk) for reporting the issue!)
...
* Fixed the issue with incorrect version number when checking for updates
...
* Fixed the issue which the "Recently Opened" section may be displaying incorrectly when opening BBG for the first time
* The layout of the menu bar has been adjusted to make it more reasonable

## 20211016

* Visual tweak and optimize some part of the copywriting
* Fixed the bug which blog configuration could not be saved when public comment service was enabled
* <del>From this release onwards, DEB package downloads will be available</del> and will not be available right now due to limited time and energy
